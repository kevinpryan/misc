...
process RENAME_FILES{
    ...
    """
    #!/bin/bash
    bash '${baseDir}/bin/rename_symlink_dna.sh' -f $new_filenames -d $dna_seq_type -r $rna_seq_type
     """
}
...
process RENAME_FILES_RNA{
    ...
    """
    #!/bin/bash
    bash '${baseDir}/bin/rename_rna_only_symlink.sh' -f $new_filenames -r $rna_seq_dir
     """
}
